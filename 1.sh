...
echo $cy"⟨"$pu"4"$cy"⟩"$i" -» Mbf"
echo $cy"⟨"$pu"5"$cy"⟩"$i" -» Cloning Yahoo"
echo $cy"⟨"$pu"6"$cy"⟩"$i" -» OsiF"
echo $cy"⟨"$pu"7"$cy"⟩"$i" -» Bot Reaction Facebook"
echo $cy"⟨"$pu"8"$cy"⟩"$i" -» Spam Call"
echo $cy"⟨"$pu"9"$cy"⟩"$i" -» Download Mp3"
